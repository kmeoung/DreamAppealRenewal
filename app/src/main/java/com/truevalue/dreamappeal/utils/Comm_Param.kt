...
//        "http://ec2-15-164-168-185.ap-northeast-2.compute.amazonaws.com:8080"
    ...
    const val TAG_PROFILE_IDX = "TAG_PROFILE_IDX"
    val URL_PRESENT_COMMENTS_PROFILE_IDX_TAG = "$URL_PRESENT_COMMENTS_PROFILE_IDX/tag"
    val URL_PRESENT_COMMENTS_PROFILE_IDX_TAG_IDX = "$URL_PRESENT_COMMENTS_PROFILE_IDX_TAG/$TAG_PROFILE_IDX"
    ...
    val URL_ACHIEVEMENT_COMMENTS_POST_IDX_TAG = "$URL_ACHIEVEMENT_COMMENTS_POST_IDX/tag"
    val URL_ACHIEVEMENT_COMMENTS_POST_IDX_TAG_IDX = "$URL_ACHIEVEMENT_COMMENTS_POST_IDX_TAG/$TAG_PROFILE_IDX"
    ...
    val URL_ACTION_COMMENTS_POST_IDX_TAG = "$URL_ACTION_COMMENTS_POST_IDX/tag"
    val URL_ACTION_COMMENTS_POST_IDX_TAG_IDX = "$URL_ACTION_COMMENTS_POST_IDX_TAG/$TAG_PROFILE_IDX"
