...
object Comm_Param {
    ...
    val URL_ACHIVEMENT_POSTS_PROFILE = "$URL_ACHIVEMENT_POSTS/profile"
    val URL_ACHIVEMENT_POSTS_PROFILE_PROFILE_IDX = "$URL_ACHIVEMENT_POSTS_PROFILE/$PROFILE_INDEX"
    val URL_ACHIVEMENT_POSTS_PROFILE_PROFILE_IDX_POST_SIZR = "$URL_ACHIVEMENT_POSTS_PROFILE_PROFILE_IDX/POST_SIZE"
